...
class WhyHomosexualityMisleadsPage extends HTMLElement {
    async connectedCallback() {
        ...
        try {
            const templateContent = await loadTemplate('./templates/why-homosexuality-misleads.html');
...
customElements.define('why-homosexuality-misleads-page', WhyHomosexualityMisleadsPage);
